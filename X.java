/* Generated By:JavaCC: Do not edit this line. X.java */
import java.io.*;
public class X implements XConstants {

    public static void main(String args[]) throws
    ParseException, IOException {

        X lex = new X(new FileInputStream(args[0]));
        lex.X();
